...
import semanticAnalyzer.entities.predefined.String;

import java.util.HashMap;

public class SymbolTable {
    private static SymbolTable symbolTable = null;
    private final HashMap<java.lang.String, Class> classes = new HashMap<>();
    ...
    Class existsClass(java.lang.String className){
        return classes.get(className);
    }

    Interface existsInterface(java.lang.String className){
        return interfaces.get(className);
    }

    public void initializePredefined(){
        classes.put("Object", new Object());
        classes.put("System", new semanticAnalyzer.entities.predefined.System());
